...
const RightSideBar = () => {
  ...
  const popularTags = [
    ...
    { _id: "5", name: "reactquery", questions: 75 },
  ];

  return (
    <section
      className="pt-36 custom-scrollbar background-light900_dark200 light-border sticky right-0 top-0  h-screen w-[350px] gap-6 overflow-y-auto
